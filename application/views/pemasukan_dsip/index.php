<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">PT. DSIP - IT Inventory Report</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">Home</li>
                        <li class="breadcrumb-item">Master</li>
                        <li class="breadcrumb-item active">Pemasukan Barang</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if ($this->session->userdata('import') == 1) { ?>
                        <form action="<?= base_url('Pemasukan_Dsip/import_excel'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="row mb-2">
                    ...
                    <form id="form-filter" class="form-horizontal">
                        <div class="row mb-2">
                            ...
                            <div class="col-3 col-md-3">
                                <input type="date" class="form-control " name="TGLMSA" id="start" />
                            </div>
                            <label class="col-6 col-md-2">To</label>
                            <div class="col-md-3 col-6">
                                <input type="date" class="form-control" name="TGLMSA_KLR" id="end" />
                            </div>
                        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive mt-4">
                    <table id="tablePemasukan" class="table table-sm">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>JenisDok.</th>
